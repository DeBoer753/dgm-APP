    ...
    return (
        ...
        <div className="max-w-md bg-orange-950 bg-opacity-90 p-5 shadow-lg w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="first-name" className="text-gray-200 text-md">First Name*</label>
                    <input
                        id="first-name"
                        name="first-name"
                        type="text"
                ...
                <div>
                    <label htmlFor="last-name" className="text-gray-200 text-md">Last Name*</label>
                    <input
                        id="last-name"
                        name="last-name"
                        type="text"
                ...
                <div>
                    <label htmlFor="email" className="text-gray-200 text-md">Email*</label>
                    <input
                        id="email"
                        name="email"
                        type="email"
                ...
                <div>
                    <label htmlFor="message" className="text-gray-200 text-md">Message*</label>
                    <textarea
                        id="message"
                        name="message"
