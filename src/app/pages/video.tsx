...
export default function Video() {
    ...
    const images = [
        { src: "/imgs/breakingout_banner.png", alt: "Image of David Glass's award winning 'film Breaking Out'" },
        { src: "/imgs/david_trophy.png", alt: "Image of David Glass holding a trophy award by his piano wearing black t-shirt and blue jeans" },
        { src: "/imgs/david_piano2.png", alt: "Image of David Glass sitting at a piano looking away from camera" },
    ];
        ...
        <div className="flex flex-col items-center w-full pt-20 pb-20 bg-gradient-to-b from-zinc-600 to-zinc-400">
            ...
            >
                <FlexStack className="justify-center text-white w-full overflow-hidden">
                    <h1 className="text-2xl pt-5 px-5 font-thin text-opacity-90">Video</h1>
                    ...
                    <motion.p 
                        ...
                        viewport={{ once: true }}
                    >
                        “Breaking Out” is a short music video produced by David Glass. 
                ...
                <div className="w-full flex flex-col justify-center">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            aria-label={images[currentIndex].alt || "Slideshow image from Breaking Out music video"}
                        >
                            <Image
                                src={images[currentIndex].src}
                                alt={images[currentIndex].alt || "Slideshow image from Breaking Out music video"} 
                                width={300}            
                                height={160}            
